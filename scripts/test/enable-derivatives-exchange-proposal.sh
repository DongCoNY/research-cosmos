...
yes $PASSPHRASE | injectived tx exchange propose-exchange-enable "derivatives" --title="$Title" --description="$Description" --deposit="100000000000inj" --from=genesis $TX_OPTS
