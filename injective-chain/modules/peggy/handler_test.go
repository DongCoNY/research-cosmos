...
func TestHandleMsgSendToEth(t *testing.T) {
	...
	var (
		userCosmosAddr, _           = sdk.AccAddressFromBech32("inj12t9868urj32x458n9cjc09zpdxmc4svtxrq3hj")
...
func TestMsgDepositClaimSingleValidator(t *testing.T) {
	...
	var (
		myOrchestratorAddr, _ = sdk.AccAddressFromBech32("inj1rgmw7dlgwqpwwf3j8zy4qvg9zkvtgeuy568fff")
		myCosmosAddr, _       = sdk.AccAddressFromBech32("inj1l0zxkd8tkam0tvg68uqh7xvym79mtw8329vd43")
	...
	fmt.Println("myOrch", myOrchestratorAddr, "MyVaAddr", myValAddr)
...
func TestMsgDepositClaimsMultiValidator(t *testing.T) {
	...
	var (
		orchestratorAddr1, _ = sdk.AccAddressFromBech32("inj1f2kdg34689x93cvw2y59z7y46dvz2fk8g3cggx")
		orchestratorAddr2, _ = sdk.AccAddressFromBech32("inj13c0m2t3hmaqp43rw0t97utvy5dc7ckte8f9tea")
		orchestratorAddr3, _ = sdk.AccAddressFromBech32("inj12t9868urj32x458n9cjc09zpdxmc4svtxrq3hj")
		myCosmosAddr, _      = sdk.AccAddressFromBech32("inj1dqryh824u0w7p6ajk2gsr29tgj6d0nkfwsgs46")
