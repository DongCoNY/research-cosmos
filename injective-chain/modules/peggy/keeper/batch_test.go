...
func TestPoolTxRefund(t *testing.T) {
	...
	var (
		now                 = time.Now().UTC()
		mySender, _         = sdk.AccAddressFromBech32("inj1dqryh824u0w7p6ajk2gsr29tgj6d0nkfwsgs46")
		myReceiver          = common.HexToAddress("0xd041c41EA1bf0F006ADBb6d2c9ef9D425dE5eaD7")
		myTokenContractAddr = common.HexToAddress("0x429881672B9AE42b8EbA0E26cD9C73711b891Ca5") // Pickle
		allVouchers         = sdk.NewCoins(
...
func TestInvalidClaimData(t *testing.T) {
	input := testpeggy.CreateTestEnv(t)
	ctx := input.Context
	claimData := `{
		"@type": "/injective.exchange.v1beta1.MsgDeposit",
		"sender": "0xa9707711bf7d464f4ea3cafc4947267dbd71958a",
		"subaccountId": "0xa9707711bf7d464f4ea3cafc4947267dbd71958a000000000000000000000000",
		"amount": {"denom": "inj", "amount": "10000000000000000000"}}`
	_, err := input.PeggyKeeper.ValidateClaimData(ctx, claimData, sdk.MustAccAddressFromBech32("inj1f2kdg34689x93cvw2y59z7y46dvz2fk8g3cggx"))
	require.Error(t, err)
}
